...
报告会统计脚本数量、标题/人设/配音说明缺口、重复标题、配音说明集中度、整段重复脚本、重复口播格、结尾类型与开头短语集中度、第一人称结论公式、隐性价值总结、不自然动宾、压缩式金句、固定反问结尾、旁白格填满情况，以及原稿中非空结尾被改稿清空的数量和位置。它用于定位批量问题，不代替逐条理解人物和场景；配音说明更丰富、结尾形式更分散，也不能单独证明台词已经自然。
